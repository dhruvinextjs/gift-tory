...
//                   }}
//                 />
//                 {/* Fallback color if image path is empty */}
...
//           {/* Apply Coupon Box */}
//           <div className="border border-dashed border-[#C3C3C3] p-3 rounded bg-[#F9F3F3] flex justify-between items-center cursor-pointer">
...
//             {/* Exactly as requested: "Oder Summary" */}
//             <h3 className="font-semibold text-[17px] text-[#111111] mb-4">Oder Summary</h3>

//             {/* Product Snapshot Mini Row */}
//             <div className="flex gap-3 items-center mb-5">
//               <div className="w-12 h-16 bg-[#F3F0EA] rounded border border-gray-100 overflow-hidden flex-shrink-0">
...
//                   />
//                 </div>
//                 {/* Fallback box - Jo tabhi dikhega jab image break ho ya path na mile */}
...
import Image from "next/image";
import { useRouter } from "next/navigation";
import { useState } from "react"; // FIXED: state import ki coupon toggle ke liye
import { LuTicketPercent } from "react-icons/lu";
import { RiDeleteBin6Line } from "react-icons/ri";
