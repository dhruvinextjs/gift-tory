...
export default function BestSeller() {
  return (
    <div className="bg-[#00000008] py-12 px-6 md:px-16">
          ...
          {products.map((product) => (
            <div key={product.id} className="group cursor-pointer">
              ...
              <div className="relative aspect-square rounded-2xl overflow-hidden mb-4 shadow-sm bg-white">
                ...
                {/* Add to Cart Overlay (Hover/Static for specific card) */}
                {/* Add to Cart Overlay (Hover Effect) */}
                <div className="absolute inset-0 bg-black/40 flex items-end p-4 transition-all duration-300 opacity-0 group-hover:opacity-100">
                  <button className="w-full py-2 border border-white text-white rounded-md flex items-center justify-center gap-2 text-sm font-medium hover:bg-white/20 transition backdrop-blur-sm">
              ...
              <div className="space-y-1">
                ...
                <div className="flex items-center gap-1">
                  ...
                  <span className="text-xs font-semibold text-[#020907]">
                    {product.rating}
                  </span>
                  <span className="text-xs text-[#020907]">
                    ({product.reviews} reviews)
                  </span>
                </div>

                <div className="flex items-center gap-2 mt-1">
                  <span className="text-lg font-bold text-[#020907]">
                    ₹{product.price}
                  </span>
